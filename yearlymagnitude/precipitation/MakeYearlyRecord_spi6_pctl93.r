...
global_precip <- st_read("GADM/gadm36_0.shp") #read in shapes of countries
...
metdata <- brick("/proj/bolinc/users/x_aidjo/Disasters/tp180_modernpctl.nc",varname="pctl") 
...
## Save the data frame
save(global_precip,file="CDHR2019_spi6_pctl93.rda")
