...
Rscript MakeYearlyRecord_spi6_pctl84.r
Rscript MakeYearlyRecord_spi6_pctl93.r
Rscript MakeYearlyRecord_spi6_pctl98.r

## Make yearly magnitude records for the accumulated precipitation extremes: low
Rscript MakeYearlyRecord_spi6_pctl16.r
Rscript MakeYearlyRecord_spi6_pctl07.r
Rscript MakeYearlyRecord_spi6_pctl02.r
