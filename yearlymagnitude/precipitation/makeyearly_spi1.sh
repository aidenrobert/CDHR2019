...
Rscript MakeYearlyRecord_spi1_pctl84.r
Rscript MakeYearlyRecord_spi1_pctl93.r
Rscript MakeYearlyRecord_spi1_pctl98.r

## Make yearly magnitude records for the accumulated precipitation extremes: low
Rscript MakeYearlyRecord_spi1_pctl16.r
Rscript MakeYearlyRecord_spi1_pctl07.r
Rscript MakeYearlyRecord_spi1_pctl02.r
